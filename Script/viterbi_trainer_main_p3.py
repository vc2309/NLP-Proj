...
bookname_list=['not','SUBJECT','TOPIC','BOOKNAME']
labeled_features = []

training_file = open("../chat_history/kq2.txt", "r")
training_label_file = open("../chat_history/ks2.txt", "r")
with open("../chat_history/kq2.txt", "r") as f:
...
# TODO
testing_file = open("../chat_history/kq2.txt", "r")
test_labels  = open("../chat_history/ks2.txt","r")
...
f = open("MEMM-multi-label-vNEWEST.pickle", "wb")
...
f = open('MEMM-multi-label-vNEWEST.pickle', 'rb')
